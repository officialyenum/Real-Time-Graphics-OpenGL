...
bool Simulation::Initialise()
{
	...
	m_camera->Initialise(glm::vec3(21.884f, 309.601f, 278.930f), glm::vec3(-0.012f, 3.707f, 0.0f)); //Apple
	//m_camera->Initialise(glm::vec3(532.0f, 880.f, -2156.f), glm::vec3(0.33f, 3.9f, 0.0f)); // Jeep
